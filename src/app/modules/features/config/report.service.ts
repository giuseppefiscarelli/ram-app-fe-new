  ...
  async generateReport(type, dataReport, veicoli?: Veicolo[], allegatiVeicoli?: Allegato[], typeIstance?: TypeIstance, istanza?: Istanza) {
      ...
      content.push(
        ...
        { text: 'AVVERTENZE:', bold: true },
        {
          text: [
            ...
            { text: 'art. 1 comma 4 del D.M. 461/2021 i mezzi oggetto di contributo non possono essere alienati, concessi in locazione o in noleggio e devono rimanere nella piena disponibilità del beneficiario del contributo entro il triennio decorrente dalla data di erogazione del contributo, pena la revoca del contributo erogato. ', bold: true },
    ...
    if (type === 'rigetto') {
      ...
      content.push(
        ...
        { text: `Protocollo Istanza ES ${dataReport['idRam']}/${dataReport['year']} Informativa ai sensi dell'art.10-bis legge 241/90`, bold: true, margin: [0, 5, 0, 5], alignment: 'justify' },
        ...
        },
        {
          text: [
            ...
            { bold: true, decoration: 'underline', text: 'dovrà essere inviata alla RAM S.p.A., esclusivamente presso il seguente indirizzo di posta elettronica certificata: ram.investimentielevatasostenibilita@legalmail.it' },
    ...
    if (type === 'inammissibilita') {
      let logo = await this.getBase64ImageFromURL('../../../../assets/report/mit3.png');
      // firma  = await this.getBase64ImageFromURL('../../../../assets/report/firma_disanto.png');
      let firma = await this.getBase64ImageFromURL('../../../../assets/report/firma_fedele.jpg');
      ...
      content.push(
        ...
        { text: 'Oggetto: Contributi ai sensi del D.D. 7 aprile 2022 n.148 per le finalità di cui al D.M. 18 novembre 2021 n. 461 - "Incentivi agli investimenti nel settore dell\'autotrasporto" ', bold: true, margin: [0, 5, 0, 5], alignment: 'justify' },
        { text: 'IL DIRETTORE GENERALE', alignment: 'center', margin: [0, 10], bold: true },
        {
          ul: [
            ...
            { text: `VISTO il verbale di riunione della Commissione, istituita ai sensi dell'art. 12, comma 3, D.D. 7 aprile 2022 n.148 , tenutasi il giorno ${moment(Number(dataReport['dataVerbale'])).format('DD/MM/YYYY')}` },
    ...
    if (type === 'deduzioni') {
      ...
      content.push(
        ...
        { text: 'Oggetto: Contributi ai sensi del D.D. 7 aprile 2022 n.148 per le finalità di cui al D.M. 18 novembre 2021 n. 461 - "Incentivi agli investimenti nel settore dell\'autotrasporto". Elevata sostenibilità ', bold: true, margin: [0, 5, 0, 5], alignment: 'justify' },
        { text: `Protocollo Istanza ES ${dataReport['idRam']}/${dataReport['year']} `, bold: true, margin: [0, 5, 0, 5], alignment: 'justify' },
        { text: 'IL DIRETTORE GENERALE', alignment: 'center', margin: [0, 10], bold: true },
        ...
        { alignment: 'justify', margin: [0, 5, 0, 5], text: `VISTO il verbale della riunione della Commissione, istituita ai sensi dell'art. 7, comma 3, del D.D. 7 aprile 2022 n.148, tenutasi in data ${moment(dataReport['dataVerbale']).format('DD/MM/YYYY')};` },
