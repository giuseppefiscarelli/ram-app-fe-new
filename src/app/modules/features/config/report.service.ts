  ...
  async generateReport(type, dataReport, veicoli?: Veicolo[], allegatiVeicoli?: Allegato[], typeIstance?: TypeIstance, istanza?: Istanza) {
    ...
    pdfMake.fonts = {
      ...
      'CalibriLight': {
        normal: 'CALIBRIL.TTF',
        bold: 'CALIBRIL.TTF',
        italics: 'CALIBRILI.TTF',
        bolditalics: 'CALIBRILI.TTF',
      },
      'Times': {
        normal: 'times.ttf',
        bold: 'timesbd.ttf',
    ...
    if (type === 'integrazione') {
          ...
          columns: [
            {
              ...
              stack: [
                ...
                // },
                {
                  text: 'Divisione incentivi, agevolazioni\ne misure per le imprese',
                  alignment: 'center',
                  fontSize: 10.5,
                  font: 'CalibriLight',
                  margin: [0, 5, 0, 0],
              ...
              : []),
            {
              table: {
                ...
                body: [
                  [
                    {
                      text: "Il Responsabile\n Area Incentivi per l'autotrasporto",
                      alignment: 'center',
                      fontSize: 11,
                    },
                  ],
      ...
      footer = {
        ...
        columns: [
          {
            text: 'RAM Logistica Infrastrutture e Trasporti Spa\nVia Nomentana, 2 00161 Roma\nT +39 06 44124461 / F +39 06 44126168\ninfo@ramspa.it - www.ramspa.it',
            fontSize: 7,
            color: '#548cd4',
            font: 'Arial',
          },
          {
            text: "Azionista unico Ministero dell'Economia e delle Finanze\nCapitale sociale € 1.000.000,00\nIscritta al Registro delle Imprese di Roma\nP.IVA e C.F 07926631008",
            fontSize: 7,
            color: '#548cd4',
            font: 'Arial',
          },
    ...
    if (type === 'inammissibilita') {
      ...
      content.push(
        // { text: 'Prot n° ' + dataReport['numProt'], margin: [0, 25, 0, 0] },
        // { text: 'Roma li ' + moment(Number(dataReport['dataProt'])).format('DD/MM/YYYY') },
        { text: 'Spett.Le', alignment: 'right', margin: [0, 20, 0, 0] },
    ...
    if (type === 'inammissibilita-parziale') {
      let logo = await this.getBase64ImageFromURL('../../../../assets/report/mit3.png');
      //let firma  = await this.getBase64ImageFromURL('../../../../assets/report/firma_resp.png');
      let firma = await this.getBase64ImageFromURL('../../../../assets/report/firma_fedele.jpg');
      ...
      content.push(
        ...
        { text: 'IL DIRETTORE GENERALE', alignment: 'center', margin: [0, 10], bold: true },
        {
          ul: [
            ...
            { text: `CONSIDERATO che la documentazione trasmessa in riscontro al punto 1 della richiesta di integrazione – ai sensi
                    dell’art. 3, comma 5, lettere a), b), c) del D.D. n. 242/2023 – non risulta conforme ai requisiti prescritti a pena di
                    inammissibilità, nei termini e secondo le modalità stabilite dal MEDESIMO decreto in quanto: ${dataReport['motivazioneInammissibilita']};`},

            { text: `DATO ATTO che la carenza sopra evidenziata integra causa di inammissibilità dell’istanza ai sensi del citato art. 3
                      del D.D. n. 242/2023;` },
            { text: `DATO ATTO altresì che, stante la mancanza dei requisiti essenziali a pena di inammissibilità, l’eventuale ulteriore
                    documentazione prodotta in risposta alla medesima richiesta non è stata oggetto di valutazione ai fini della
                    rendicontazione;` },

            { text:`VISTO il verbale della riunione della Commissione, istituita ai sensi dell’art. 10, comma 3, del D.D. 8 giugno
                    2023, n. 242, svoltasi in data ${moment(Number(dataReport['dataVerbale'])).format('DD/MM/YYYY')}, dal quale risulta che la documentazione trasmessa è
                    stata ritenuta non accoglibile; `},

            { text:`RITENUTO che le carenze sopra evidenziate assumono carattere assorbente ai fini della declaratoria di
        ...
        { text:`${dataReport['motivazioneInammissibilita']}`,
          ...
          alignment: 'justify'},
        { text: `Il presente provvedimento costituisce determinazione conclusiva del procedimento amministrativo. Si comunica
altresì che, ai sensi dell'art. 3, comma 4, della legge 7 agosto 1990 n. 241, avverso il presente atto è ammesso
ricorso giurisdizionale avanti al competente Tribunale Amministrativo Regionale oppure, in alterativa, ricorso
straordinario al Presidente della Repubblica, rispettivamente entro sessanta e centoventi giorni dal ricevimento
dello stesso.`, alignment: 'justify' },
        {
          text: [
            { text: 'Il Direttore Generale \n' },
            { text: 'dr. ing. Fausto Fedele' },
