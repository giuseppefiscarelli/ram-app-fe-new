  ...
  async generateReport(type: any, dataReport: any, veicoli?: Veicolo[], allegatiVeicoli?: Allegato[], typeIstance?: TypeIstance, istanza?: Istanza) {
    ...
    if (type === 'inammissibilita') {
      ...
      content.push(
        ...
        { margin: [0, 7],text: `CONSIDERATO che la documentazione trasmessa in riscontro al punto 1 della richiesta di integrazione – ai sensi dell’art. 3, comma 5, lettere a), b), c) del D.D. n. 28/2024 – non risulta conforme ai requisiti prescritti a pena di inammissibilità, nei termini e secondo le modalità stabilite dal MEDESIMO decreto in quanto: ${dataReport['motivazioneInammissibilita']};`,alignment: 'justify'},
        { margin: [0, 7],text: `DATO ATTO che la carenza sopra evidenziata integra causa di inammissibilità dell’istanza ai sensi del citato art. 3 del D.D. n. 28/2024;` },
        ...
        { margin: [0, 7],text:`VISTO il verbale della riunione della Commissione, istituita ai sensi dell’art. 10, comma 3, del D.D. 31 gennaio 2024, n. 28, svoltasi in data ${moment(Number(dataReport['dataVerbale'])).format('DD/MM/YYYY')}, dal quale risulta che la documentazione trasmessa è stata ritenuta non accoglibile; `},
